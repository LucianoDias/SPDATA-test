...
import br.com.dev.drogaria.dao.CidadeDAO;
import br.com.dev.drogaria.dao.EstadoDAO;
import br.com.dev.drogaria.dao.PessoaDAO;
...
public class PessoaBean implements Serializable {
	...
	public void listar(){
		try{
			...
			Messages.addGlobalError("Ocorreu um erro ao lista pessoas");
	...
	public void novo(){
		try{
			...
			Messages.addGlobalError("Ocorreu um erro ao lista estado");
			erro.printStackTrace();
		}
	}
	...
	public void popular(){
		try{
			...
			Messages.addGlobalError("Ocorreu um erro ao filtra cidade");
			erro.printStackTrace();
		}
	}
